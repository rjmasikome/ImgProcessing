...
then
sed -i '/task4(img1, img2, img3)/c\#task4(img1, img2, img3)' 2-1.py
...
do
   ...
   python 2-1.py
   sed -i '/m_size = 5/c\m_size = get_mask_size()' 2-1.py
   sed -i '/m_size = get_mask_size()/c\m_size = 7' 2-1.py
   python 2-1.py
   sed -i '/m_size = 7/c\m_size = get_mask_size()' 2-1.py
   sed -i '/m_size = get_mask_size()/c\m_size = 9' 2-1.py
   python 2-1.py
   sed -i '/m_size = 9/c\m_size = get_mask_size()' 2-1.py
   sed -i '/m_size = get_mask_size()/c\m_size = 11' 2-1.py
   python 2-1.py
   sed -i '/m_size = 11/c\m_size = get_mask_size()' 2-1.py
   sed -i '/m_size = get_mask_size()/c\m_size = 13' 2-1.py
   python 2-1.py
   sed -i '/m_size = 13/c\m_size = get_mask_size()' 2-1.py
   sed -i '/m_size = get_mask_size()/c\m_size = 15' 2-1.py
   python 2-1.py
   sed -i '/m_size = 15/c\m_size = get_mask_size()' 2-1.py
   sed -i '/m_size = get_mask_size()/c\m_size = 17' 2-1.py
   python 2-1.py
   sed -i '/m_size = 17/c\m_size = get_mask_size()' 2-1.py
   sed -i '/m_size = get_mask_size()/c\m_size = 19' 2-1.py
   python 2-1.py
   sed -i '/m_size = 19/c\m_size = get_mask_size()' 2-1.py
   sed -i '/m_size = get_mask_size()/c\m_size = 21' 2-1.py
   python 2-1.py
   sed -i '/m_size = 21/c\m_size = get_mask_size()' 2-1.py
done

sed -i '/#task4(img1, img2, img3)/c\task4(img1, img2, img3)' 2-1.py
sed -i '/m_size = get_mask_size()/c\m_size = 3' 2-1.py
python 2-1.py
sed -i '/m_size = 3/c\m_size = get_mask_size()' 2-1.py
