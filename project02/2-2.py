...
plt.subplot(223),plt.imshow(gradx, cmap = 'gray'), plt.title('Derivative in Y direction')
plt.subplot(224),plt.imshow(grady, cmap = 'gray'), plt.title('Derivative in X direction')
